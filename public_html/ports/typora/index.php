...
<header id="header">
	...
	<div class="container">
		<div class="row">
			<div class="tiny-12">
                <br>
				<h1><img src="../../assets/img/typora.png" alt="Typora Icon" style="position:relative; top:0.3rem; height:3rem; display:inline-block;"> Sarcastic White for Typora</h1>
                <p><strong>Sarcastic White</strong> is a theme for Typora that changes the original appearance to a dark blue-ish look and feel. We've created the theme with a clean and uncluttered design pattern in mind, to achieve optimal focus and readability for code, syntax highlighting and UI components.</p>
            </div>	
		</div>
	</div>
</header>
    ...
    <div class="container">
        <div class="row">
			<div class="tiny-12">
                ...
                <ol>
                    <li>Download the theme files <a href="/ports/typora/sarcasticwhite.zip">here</a>.</li>
                    <li>From Typora, click <code>CMD</code>+<code>,</code>.</li>
                    <li>Select Appearance.</li>
                    <li>Click <code>Open Theme Folder</code>.</li>
                    <li>Copy the contents of the downloaded folder to the themes folder.</li>
                    <li>Restart Typora and navigate to Settings -> Appearance once again.</li>
                    <li>You can now select the Sarcastic White theme from the dropdown.</li>
                </ol>
            </div>	
		</div>
    </div>
