    ...
    <div class="container">
        <div class="row">
			<div class="tiny-12">
                ...
                <ol>
                    <li>Start by downloading the <a href="sarcastic-white.itermcolors" download>theme file</a>.</li>
                    <li>
                        When you have the theme file, open iTerm2 and head to: <br>
                        <code>Settings</code> &rightarrow; <code>Profiles</code> &rightarrow; <code>Colors</code> &rightarrow; <code>Color Presets...</code> &rightarrow; <code>Import</code>
                        <img src="../../assets/img/iterm2-example.png" style="max-width:850px;width:100%;box-shadow:var(--shadow04);border-radius:var(--spacing01)" alt="">
                    </li>
