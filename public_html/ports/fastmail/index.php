...
<header id="header">
	...
	<div class="container">
		<div class="row">
			<div class="tiny-12">
                <br>
				<h1><img src="../../assets/img/fastmail.png" alt="fastmail Icon" style="position:relative; top:0.3rem; height:3rem; display:inline-block;"> Sarcastic White for Fastmail</h1>
                <p><strong>Sarcastic White</strong> is a theme for Fastmail that changes the original appearance to a dark blue-ish look and feel. We've created the theme with a clean and uncluttered design pattern in mind, to achieve optimal focus and readability for code, syntax highlighting and UI components.</p>
            </div>	
		</div>
	</div>
</header>
    ...
    <div class="container">
        <div class="row">
			<div class="tiny-12">
                ...
                <ol>
                    <li>Go to Settings in the Fastmail webapp</li>
                    <li>Click <strong>Display options</strong></li>
                    <li>Scroll down to <strong>Color</strong> and paste the following: <code>#94b7e1,#5e82ac,#5e82ac,#94b7e1</code></li>
                </ol>
                <br><br><br>
            </div>	
		</div>
